<?php
use Carbon\Carbon;
$now = Carbon::now('Asia/Ha Noi')->toDateString();
$duocduyet = 1;
        ...
        <div class="container">
            <div class="float--left float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-info nav">
                    <li><i class="fa fm fa-map-marker"></i>Hưng Yên</li>
            ...
            <div class="float--right float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-social nav hidden-sm hidden-xxs">
                    <li><a href="https://www.facebook.com/phong.nino.92"><i class="fa fa-facebook"></i></a></li>
