 ...
 <footer class="footer--section">
                ...
                <div class="col-md-3 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                    ...
                    <div class="widget">
                        ...
                        <div class="about--widget">
                            <div class="content">
                                <p>SEK19, Khoa Công nghệ thông tin,Trường đại học sư phạm kỹ thuật Hưng Yên</p>
                            </div>
                            ...
                            <ul class="nav">
                                <li>
                                    <i class="fa fa-map"></i>
                                    <span>RX9P+MPH, ĐT204, Phùng Hưng, Khoái Châu, Hưng Yên</span>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o"></i>
                                    <a href="mailto:example@example.com">tahongphong03@gmail.com</a>
                                </li>
                                <li>
                                    <i class="fa fa-phone"></i>
                                    <a href="tel:+0986405762">+0986405763</a>
                                </li>
                            </ul>
                        </div>
                        <!-- About Widget End -->
    ...
    <div class="footer--copyright bg--color-3">
        ...
        <div class="container">
            <p class="text float--left">&copy; 2024 triển bởi <a href="#">KCNEWS</a>. All Rights Reserved.</p>
