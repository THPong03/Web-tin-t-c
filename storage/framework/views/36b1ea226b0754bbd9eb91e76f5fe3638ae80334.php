...
<div class="single-img--section ptop--30">
    <div class="container">
        <img src="<?php echo e(url('public/frontend')); ?>/img/about-img/peoples.jpg" alt="" class="center-block">
    </div>
</div>
<!-- Single Image Section End -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KCNEW\resources\views/frontend/pages/about.blade.php ENDPATH**/ ?>