        ...
        <div class="container">
            <div class="float--left float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-info nav">
                    ...
                    <li><i class="fa fm fa-calendar"></i></li>
                </ul>
            ...
            <div class="float--right float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-action nav">
                    <li><a href="<?php echo e(route('login')); ?>"><i class="fa fm fa-user-o"></i>Login/Register</a></li>
                </ul>
    ...
    <div class="header--mainbar">
        <div class="container">
            ...
            <div class="header--logo float--left float--sm-none text-sm-center">
                <h1 class="h1">
                    <a href="home-1.html" class="btn-link">
                        <img src="<?php echo e(url('public/frontend')); ?>/img/logo.png" alt="USNews Logo">
            ...
            <div class="header--ad float--right float--sm-none hidden-xs">
                <a href="#">
                    <img src="<?php echo e(url('public/frontend')); ?>/img/ads-img/ad-728x90-01.jpg" alt="Advertisement">
                </a>
            </div>
            <!-- Header Ad End -->
        </div>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="home-3.html">Home Version 03</a></li>
...
<!-- News Ticker End --><?php /**PATH C:\xampp\htdocs\KCNEW\resources\views/frontend/navbar.blade.php ENDPATH**/ ?>