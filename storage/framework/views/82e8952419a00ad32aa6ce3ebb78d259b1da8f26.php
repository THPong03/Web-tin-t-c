            ...
            <div class="list--widget list--widget-1">
                ...
                <div class="post--items post--items-3" data-ajax-content="outer">
                    <ul class="nav" data-ajax-content="inner">
                        <?php $__currentLoopData = $xemnhieu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $xuhuong): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <!-- Post Item Start -->
                                <div class="post--item post--layout-3">
                                    <div class="post--img">
                                        <a href="<?php echo e(url('/bai-viet-' . $xuhuong->slug)); ?>" class="thumb"><img
                                                src="public/uploads/tintuc/<?php echo e($xuhuong->hinhanh); ?>" alt=""></a>
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h3 class="h4"><a href="<?php echo e(url('/' . $xuhuong->slug)); ?>"
                                                        class="btn-link"><?php echo e($xuhuong->title); ?></a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\KCNEW\resources\views/frontend/manager/mainsidebar.blade.php ENDPATH**/ ?>