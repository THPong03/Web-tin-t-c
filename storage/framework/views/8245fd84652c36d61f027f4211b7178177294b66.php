...
<body>
    ...
    <div class="wrapper">
        <!-- 404 Section Start -->
        <div class="f0f--section pd--100-0" data-bg-img="<?php echo e(url('public/frontend')); ?>/img/404-img/bg.jpg">
            <div class="container">
                <div class="row">
...
<?php /**PATH C:\xampp\htdocs\KCNEW\resources\views/frontend/pages/404.blade.php ENDPATH**/ ?>