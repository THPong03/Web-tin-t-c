...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="coming-soon--section pd--100-0" data-bg-img="<?php echo e(url('public/frontend')); ?>/img/coming-soon-img/bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-4 col-xs-10 col-xs-offset-1 col-xxs-12">
                        ...
                        <div class="coming-soon--content">
                            <div class="logo">
                                <img src="<?php echo e(url('public/frontend')); ?>/img/coming-soon-img/logo.png" alt="">
                            </div>
...
<?php /**PATH C:\xampp\htdocs\KCNEW\resources\views/frontend/pages/coming.blade.php ENDPATH**/ ?>